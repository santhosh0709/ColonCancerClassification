...
# In[2]:
PATH = "/content/drive/MyDrive/RCCNet-master/crchistophenotypes32_32"
print("PWD", PATH)
...
csv_logger = CSVLogger('/content/drive/MyDrive/RCCNet-master/Records/GoogleNet/True/GoogleNet_DataAugTrue.csv', append=True, separator=';')
...
plt.savefig("/content/drive/MyDrive/RCCNet-master/Records/GoogleNet/True/GoogleNet_accuracy_T")
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("/content/drive/MyDrive/RCCNet-master/Records/GoogleNet/True/GoogleNet_loss_T")
plt.show()
