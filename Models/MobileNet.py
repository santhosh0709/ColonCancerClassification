...
csv_logger = CSVLogger('/content/drive/MyDrive/MINOR_PROJECT/Models/MobileNet.csv', append=True, separator=';')
...
plt.savefig('/content/drive/MyDrive/MINOR_PROJECT/Models/MobileNet_f.png')
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig('/content/drive/MyDrive/MINOR_PROJECT/Models/MobileNet_f2.png')
plt.show()
