...
from keras.layers import Dense, Dropout, Activation, Flatten, Conv2D, MaxPooling2D, BatchNormalization,Concatenate,Input
...
PATH = "/content/drive/MyDrive/Resources/data_set"
print("PWD", PATH)
...
csv_logger = CSVLogger("/content/drive/MyDrive/Records/RCCNet/Results/RCCNet_False.csv", append=True, separator=';')
...
plt.savefig("/content/drive/MyDrive/Records/RCCNet/Results/RCCNet_accuracy_F.png")
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("/content/drive/MyDrive/Records/RCCNet/Results/RCCNet_loss_F.png")
plt.show()
