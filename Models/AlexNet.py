...
csv_logger = CSVLogger('/content/drive/MyDrive/minor/CRC_alexnet_test.csv')
...
plt.savefig("/content/drive/MyDrive/minor/CRC_alexnet_test_f1.png")
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("/content/drive/MyDrive/minor/CRC_alexnet_test_f2.png")
plt.show()